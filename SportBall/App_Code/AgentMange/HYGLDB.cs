...
public class KFB_HYGLDB
{
    ...
    public void DeleteALL(string N_HYDH, Hashtable o_aHt)
    {

        this.DeleteHYGL(N_HYDH, o_aHt);
        this.DeleteCP(N_HYDH, o_aHt);
        this.DeleteDLT(N_HYDH, o_aHt);
        this.DeleteJC539(N_HYDH, o_aHt);
        this.DeleteLHC(N_HYDH, o_aHt);
        this.DeleteLQ(N_HYDH, o_aHt);
        this.DeleteMB(N_HYDH, o_aHt);
        this.DeleteMQ(N_HYDH, o_aHt);
        this.DeleteRB(N_HYDH, o_aHt);
        this.DeleteSM(N_HYDH, o_aHt);
        this.DeleteTB(N_HYDH, o_aHt);
        this.DeleteZQ(N_HYDH, o_aHt);
        this.DeleteZS(N_HYDH, o_aHt);
        this.DeleteSS(N_HYDH, o_aHt);

        this.DeleteBQ(N_HYDH, o_aHt);
        this.DeleteCQ(N_HYDH, o_aHt);
    }
    /// <summary>
    /// 删除一条数据
    /// </summary>
    public void DeleteHYGL(string N_HYZH, Hashtable o_aHt)
    {
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteCP(string N_HYDH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPCP ");
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteDLT(string N_HYDH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPDLT ");
        strSql.Append(" where N_HYDH=:N_HYDH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYDH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYDH;
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteJC539(string N_HYDH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPJC539 ");
        strSql.Append(" where N_HYDH=:N_HYDH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYDH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYDH;
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteLHC(string N_HYDH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPLHC ");
        strSql.Append(" where N_HYDH=:N_HYDH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYDH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYDH;
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteLQ(string N_HYZH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPLQ ");
        strSql.Append(" where N_HYZH=:N_HYZH ");
        OracleParameter[] parameters = {
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteMB(string N_HYZH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPMB ");
        strSql.Append(" where N_HYZH=:N_HYZH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYZH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYZH;
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteMQ(string N_HYZH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPMQ ");
        strSql.Append(" where N_HYZH=:N_HYZH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYZH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYZH;
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteRB(string N_HYZH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPRB ");
        strSql.Append(" where N_HYZH=:N_HYZH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYZH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYZH;
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteSM(string N_HYDH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPSM ");
        strSql.Append(" where N_HYDH=:N_HYDH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYDH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYDH;
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteTB(string N_HYZH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPTB ");
        strSql.Append(" where N_HYZH=:N_HYZH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYZH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYZH;
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteZQ(string N_HYZH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPZQ ");
        strSql.Append(" where N_HYZH=:N_HYZH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYZH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYZH;
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteZS(string N_HYZH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPZS ");
        strSql.Append(" where N_HYZH=:N_HYZH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYZH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYZH;
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteSS(string N_HYDH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPSS ");
        strSql.Append(" where N_HYDH=:N_HYDH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYDH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYDH;
    ...
    public void DeleteBQ(string N_HYZH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPBQ ");
        strSql.Append(" where N_HYZH=:N_HYZH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYZH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYZH;
    ...
    /// 删除一条数据
    /// </summary>
    public void DeleteCQ(string N_HYZH, Hashtable o_aHt)
    {

        StringBuilder strSql = new StringBuilder();
        strSql.Append("delete KFB_SETUPCQ ");
        strSql.Append(" where N_HYZH=:N_HYZH ");
        OracleParameter[] parameters = {
					new OracleParameter(":N_HYZH", OracleType.VarChar,50)};
        parameters[0].Value = N_HYZH;
    ...
    /// 获得数据列表
    /// </summary>
    public DataSet GetListCASH(string strWhere)
    {
        StringBuilder strSql = new StringBuilder();
