    ...
    <script id="footTemplate" type="text/x-jquery-tmpl">
     ...
     <script id="gameTemplate" type="text/x-jquery-tmpl">
         <tr {{if $data[13] == 0}}class="graybg"{{/if}}>
            ...
            <td>
                {{html GetSpecialOther(this,21,30,"zz")}}
            </td>
             <td>
                {{html GetSpecialOther(this,22,31,"zh")}}
            </td>
             <td>
                {{html GetSpecialOther(this,23,32,"zk")}}
            </td>
             <td>
                {{html GetSpecialOther(this,24,33,"hz")}}
            </td>
             <td>
                {{html GetSpecialOther(this,25,34,"hh")}}
            </td>
             <td>
                {{html GetSpecialOther(this,26,35,"hk")}}
            </td>
             <td>
                {{html GetSpecialOther(this,27,36,"kz")}}
            </td>
             <td>
                {{html GetSpecialOther(this,28,37,"kh")}}
            </td>
             <td>
                {{html GetSpecialOther(this,29,38,"kk")}}
            </td>
            <td class="mgmiddle">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder11" runat="server"> 
     ...
     <ul class="breadcrumb" style="margin-top: 5px">
        当前位置： <a href="#"><span id="lblballType"></span>操盘</a> / <span id="lblball"></span>半全场
    </ul>
    <div class="title_right">
        <strong>半全场</strong>
    </div>
    <input id="hidPlayType" name="hidPlayType" type="hidden" value="6" />
