    ...
    <script id="footTemplate" type="text/x-jquery-tmpl">
     ...
     <script id="gameTemplate" type="text/x-jquery-tmpl">
        <tr {{if $data[13] == 0}}class="graybg"{{/if}} id="tr${$data[0]}">
            ...
            <td class="mgmiddle">
                {{html GetSetting(this,2)}}
            </td>
            <td class="mgmiddle">
                <input name="chkSelect" id="chkSelect" type="checkbox" />
            </td>
        </tr>
        </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
      ...
      <ul class="breadcrumb" style="margin-top: 5px">
        当前位置： <a href="#"><span id="lblballType"></span>操盘</a> / <span id="lblball"></span>滾球
    </ul>
    <div class="title_right">
        <strong>滾球</strong>
    </div>
    <input id="hidPlayType" name="hidPlayType" type="hidden" value="2" />
