...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
  <ul class="breadcrumb" style="margin-top: 5px">
        当前位置： <a href="#"><span id="lblballType"></span>操盘</a> / <span id="lblball"></span>垃圾桶
    </ul>
    <div class="title_right">
        <strong>垃圾桶</strong>
    </div>
    <input id="hidPlayType" name="hidPlayType" type="hidden" value="10" />
        ...
        <tr>
                ...
                <td class="ctmain">
                    <div class="tabtop">
                        ...
                        <select name="drpPageSize" onchange="" id="drpPageSize" style="display:none">
                        ...
                        <select name="drpSetting" id="drpSetting">
                            ...
                            <option value="9">彻底删除</option>
                            <option value="8">恢复比赛</option>
                        </select>
                    ...
                    <div class="footballs">
                        <table cellspacing="0" cellpadding="0" border="0" class="correct2">
                            <tr class="headpink">
                                ...
                                <td class="mgmiddle">
                                    <input id="chkAllGame" type="checkbox" onclick="checkAllGame(this);" /></td>
                            </tr>
