<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BQ_set.aspx.cs" Inherits="BQ_set" %>
                ...
                <tr>
                    ...
                    <td class="t2" style="padding-top: 4px;">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <img src="../../Images/114.gif" width="14" height="14" alt="" /></td>
                    ...
                    <td class="t5">
                        ...
                        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="pt_table">
                            <tr class="colorbg" align="center">
                                ...
                                <td>單場限額</td>
                                <td rowspan="2">
                                    <asp:Button runat="server" ID="btnCancle" Text="取消" OnClick="btnCancle_Click" /></td>
                            </tr>
