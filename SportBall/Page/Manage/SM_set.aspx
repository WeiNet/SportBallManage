<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SM_set.aspx.cs" Inherits="SM_set" %>
                    ...
                    <td class="t5">
                        ...
                        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="pt_table">
                            ...
                            <tr class="colorbg" align="center" onmouseover="changeto()" onmouseout="changeback()">
                                <td>位置</td>
                                <td>
                                    <asp:Label ID="lbtywzt" runat="server" Text="" Style="display: none"></asp:Label>
                                    <asp:DropDownList runat="server" ID="drptywz">
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    <asp:TextBox CssClass="textbox1" ID="txtdzwz" runat="server"></asp:TextBox>
                                    &lt;=<asp:Label ID="lbdzwz" runat="server" Text=""></asp:Label><asp:Label ID="lbdzwzt"
                                        runat="server" Text="" Style="display: none"></asp:Label></td>
                                <td>
                                    <asp:TextBox CssClass="textbox1" ID="txtdcwz" runat="server"></asp:TextBox>
                                    &lt;=<asp:Label ID="lbdcwz" runat="server" Text=""></asp:Label><asp:Label ID="lbdcwzt"
                                        runat="server" Text="" Style="display: none"></asp:Label></td>
                            </tr>
                            <tr class="colorbg" align="center" onmouseover="changeto()" onmouseout="changeback()">
                                <td>連贏</td>
                                <td>
                                    <asp:Label ID="lbtylyt" runat="server" Text="" Style="display: none"></asp:Label>
                                    <asp:DropDownList runat="server" ID="drptyly">
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    <asp:TextBox CssClass="textbox1" ID="txtdzly" runat="server"></asp:TextBox>
                                    &lt;=<asp:Label ID="lbdzly" runat="server" Text=""></asp:Label><asp:Label ID="lbdzlyt"
                                        runat="server" Text="" Style="display: none"></asp:Label></td>
                                <td>
                                    <asp:TextBox CssClass="textbox1" ID="txtdcly" runat="server"></asp:TextBox>
                                    &lt;=<asp:Label ID="lbdcly" runat="server" Text=""></asp:Label><asp:Label ID="lbdclyt"
                                        runat="server" Text="" Style="display: none"></asp:Label></td>
                            </tr>
                            <tr class="colorbg" align="center" onmouseover="changeto()" onmouseout="changeback()">
                                <td>位置Q</td>
                                <td>
                                    <asp:Label ID="lbtywzqt" runat="server" Text="" Style="display: none"></asp:Label>
                                    <asp:DropDownList runat="server" ID="drptywzq">
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    <asp:TextBox CssClass="textbox1" ID="txtdzwzq" runat="server"></asp:TextBox>&lt;=<asp:Label
                                        ID="lbdzwzq" runat="server" Text=""></asp:Label><asp:Label ID="lbdzwzqt" runat="server"
                                            Text="" Style="display: none"></asp:Label></td>
                                <td>
                                    <asp:TextBox CssClass="textbox1" ID="txtdcwzq" runat="server"></asp:TextBox>&lt;=<asp:Label
                                        ID="lbdcwzq" runat="server" Text=""></asp:Label><asp:Label ID="lbdcwzqt" runat="server"
                                            Text="" Style="display: none"></asp:Label></td>
                            </tr>
                        </table>
                    </td>
