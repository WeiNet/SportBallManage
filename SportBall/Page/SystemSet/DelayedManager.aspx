...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder11" runat="server">
    ...
    <div style="width: 90%; margin: auto">
        <cc1:JXGrid ID="grvHYZH" runat="server" AutoGenerateColumns="False" CssClass="grid"
            ...
            <Columns>
                <asp:HyperLinkField HeaderText="總監" DataNavigateUrlFields="n_zjdh" DataNavigateUrlFormatString="/Page/Manage/AgentManageUpd.aspx?id={0}&amp;lv=4"
                    DataTextField="n_zjdh" DataTextFormatString="{0}">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:HyperLinkField>
                <asp:HyperLinkField HeaderText="大股東" DataNavigateUrlFields="n_dgddh" DataNavigateUrlFormatString="/Page/Manage/AgentManageUpd.aspx?id={0}&amp;lv=5"
                    DataTextField="n_dgddh" DataTextFormatString="{0}">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:HyperLinkField>
                <asp:HyperLinkField HeaderText="股東" DataNavigateUrlFields="n_gddh" DataNavigateUrlFormatString="/Page/Manage/AgentManageUpd.aspx?id={0}&amp;lv=6"
                    DataTextField="n_gddh" DataTextFormatString="{0}">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:HyperLinkField>
                <asp:HyperLinkField HeaderText="總代理" DataNavigateUrlFields="n_zdldh" DataNavigateUrlFormatString="/Page/Manage/AgentManageUpd.aspx?id={0}&amp;lv=7"
                    DataTextField="n_zdldh" DataTextFormatString="{0}">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:HyperLinkField>
                <asp:HyperLinkField HeaderText="代理商" DataNavigateUrlFields="n_dldh" DataNavigateUrlFormatString="/Page/Manage/AgentManageUpd.aspx?id={0}&amp;lv=8"
                ...
                <asp:HyperLinkField HeaderText="會員" DataNavigateUrlFields="n_hyzh,n_dldh,n_zdldh,n_gddh,n_dgddh,n_zjdh"
                    DataNavigateUrlFormatString="/Page/Manage/xzhy.aspx?n_hyzh={0}&amp;n_dldh={1}&amp;n_zdldh={2}&amp;n_gddh={3}&amp;n_dgddh={4}&amp;n_zjdh={5}"
        ...
        <cc1:JXGrid ID="grvWJZH" runat="server" AutoGenerateColumns="False" CssClass="grid"
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="n_hyzh,n_hydj" DataNavigateUrlFormatString="/Page/Manage/AgentManageUpd.aspx?id={0}&amp;lv={1}"
