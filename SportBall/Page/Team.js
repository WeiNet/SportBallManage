...
function funSave(objgrvtxtName,objgrvtxtName_EN,objgrvltxtName_CN,objgrvltxtName_TW,objgrvltxtName_TH) {
...
function checkLM() {
    var txtTeam = document.getElementById("ContentPlaceHolder11_txtTeam");
   
    if (txtTeam.value.trim() == "")
  {
     alert("請輸入聯盟名稱!!");
     txtTeam.select();
       return false;
